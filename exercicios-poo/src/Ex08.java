public class Ex08 {
    public static void main(String[] args) {
        ...
        Contribuinte f2 = new Contribuinte("Carlos", "99999999999", "SC", 32000);
        Contribuinte f3 = new Contribuinte("Felix", "67676767676", "SP", 100000);
        Contribuinte f4 = new Contribuinte("Uelisson", "13131313131", "SP", 700000);
        Contribuinte f5 = new Contribuinte("Ivandel", "11223344556", "SC", 40000);
